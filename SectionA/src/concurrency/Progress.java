...
public class Progress {
  ...
  private static ConcurrentProgram makeExampleProgram() {
    ...
    List<Stmt> statements0 = new ArrayList<>();
  ...
  private static ConcurrentProgram makeExampleProgram2() {
    ...
    List<Stmt> statements3 = new ArrayList<>();
   ...
   *
   * @param expected String produced by your code
   * @param actual   String produced by correct code
   */
   ...
   *
   * @param expected int or Integer produced by your code
   * @param actual   int or Integer produced by correct code
   */
   ...
   *
   * @param expected boolean or Boolean produced by your code
   * @param actual   boolean or Boolean produced by correct code
   */
